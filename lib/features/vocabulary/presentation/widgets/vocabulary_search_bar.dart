    ...
    return Container(
      ...
      child: TextSelectionTheme(
        data: TextSelectionThemeData(
          selectionColor: zen.accent.withValues(alpha: 0.2),
          selectionHandleColor: zen.accent,
        ),
        child: TextField(
          onChanged: (value) {
            ref.read(vocabularySearchQueryProvider.notifier).setQuery(value);
          },
          cursorColor: zen.accent,
          cursorWidth: 1.0,
          ...
          decoration: InputDecoration(
            ...
            hintStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(
              color: zen.textSecondary.withValues(alpha: 0.55),
            ...
            focusedBorder: UnderlineInputBorder(
              borderSide: BorderSide(
                color: zen.textPrimary.withValues(alpha: 0.8),
                width: 0.8,
              ),
            ),
            isDense: true,
